...
const CANALES: Record<string, CanalVisual> = {
  whatsapp: { nombre: "WhatsApp", color: "#1c8a4d", forma: "whatsapp", conversacion: true },
  ...
  correo: { nombre: "Correo", color: "#7a6a52", forma: "correo", conversacion: true },
  cotizador: { nombre: "Cotizador", color: "#4a6b80", forma: "cotizador", conversacion: false },
  chatbot: { nombre: "Chatbot", color: "#5c7180", forma: "chatbot", conversacion: false },
  web: { nombre: "Formulario", color: "#6e6a63", forma: "formulario", conversacion: false },
  manual: { nombre: "Anotado a mano", color: "#6e6a63", forma: "mano", conversacion: false },
};
...
function otro(canal: string): CanalVisual {
  return { nombre: canal || "Origen desconocido", color: "#6e6a63", forma: "formulario", conversacion: false };
}
